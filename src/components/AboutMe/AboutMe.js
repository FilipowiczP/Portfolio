    ...
    return(
        <section className={show === 1 ? "aboutMe aboutMe-show" : "aboutMe"}>
            ...
            <div className="aboutMe__me">
                <h2>Kim jestem?</h2>
                <p>Od roku uczę się tworzyć strony internetowe. Głównie pracuję z JavaScript (React). Interesuje mnie zarówno Frontend jak i Backend</p>
            </div>
            <div className="aboutMe__why">
                <h2>Dlaczego programowanie</h2>
                <p>Zmieniłem branżę z logistyki ponieważ czułem brak możliwości rozwoju zawodowego. Jednak logistyka nauczyła mnie optymalizacji i 
            ...
            <div className="aboutMe__project">
                ...
                <p> Aktualnie ukończyłem pierwszą część kursu Coders Lab w której skład wchodziły moduły Frontendu, a od listopada aktualnego 
