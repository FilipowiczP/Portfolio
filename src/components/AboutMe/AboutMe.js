    ...
    return(
        <section className={show === 1 ? "aboutMe aboutMe-show" : "aboutMe"}>
            ...
            <div className="aboutMe__me">
                ...
                <p className="aboutMe__me__content">Uczę się tworzyć strony internetowe. Głównie pracuję z JavaScript (React). Interesuje mnie zarówno Frontend jak i Backend.</p>
            </div>
            <div className="aboutMe__why">
                ...
                <p className="aboutMe__why__content">Zmieniłem branżę z logistyki ponieważ czułem brak możliwości rozwoju zawodowego. Jednak logistyka nauczyła mnie optymalizacji i 
                    planowaniu zadań w dążeniu do wyznaczonego celu oraz sposobu podejścia do problemu. Takie właśnie myślenie oraz doświadczenie 
            ...
            <div className="aboutMe__project">
                ...
                <p className="aboutMe__project__content"> Aktualnie ukończyłem pierwszą część kursu Coders Lab w której skład wchodziły moduły Frontendu, od listopada aktualnego 
