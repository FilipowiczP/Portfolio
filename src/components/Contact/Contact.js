...
const Contact = ({ show }) => {
    ...
    return ( <
        ...
        name = "from_name"
        onChange = {
            (event) => dispatch({ type: 'name', payload: event.target.value }) }
        /> <
        /label> <
        ...
        name = "from_email"
        onChange = {
            (event) => dispatch({ type: 'email', payload: event.target.value }) }
        /> <
        /label> <
        ...
        name = "subject"
        onChange = {
            (event) => dispatch({ type: 'subject', payload: event.target.value }) }
        /> <
        /label> <
        ...
        name = "message"
        onChange = {
            (event) => dispatch({ type: 'message', payload: event.target.value }) }
        /> { send ? < p style = {
                { color: "green" } } > Wysłano wiadomość < /p> : <p style={{color:"red"}}>Uzupełnij wszyskie pola</p > } <
        button type = "submit"
        className = "contact__form__button" > Wyślij < /button> <
        /form> <
        /section>
    );
};
